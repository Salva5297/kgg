...
map:map_assignment_000 rml:logicalSource map:source_007 ;
    ...
    rr:predicateObjectMap map:pom_031, map:pom_032, map:pom_033, map:pom_034, map:pom_035, map:pom_036, map:pom_037 ;
...
map:map_instant_start_assignment_000 rml:logicalSource map:source_015 ;
    ...
    rr:predicateObjectMap map:pom_055, map:pom_056 ;
...
map:map_interval_task_000 rml:logicalSource map:source_011 ;
    ...
    rr:predicateObjectMap map:pom_045, map:pom_046, map:pom_047 ;
...
map:map_task_000 rml:logicalSource map:source_005 ;
    rdf:type rr:TriplesMap ;
    rdfs:label "task" ;
    rr:predicateObjectMap map:pom_016, map:pom_017, map:pom_018, map:pom_019, map:pom_020, map:pom_021, map:pom_022, map:pom_023, map:pom_024, map:pom_025 ;
...
map:om_007 rml:reference "CurrencyDigits" ;
    rdf:type rr:ObjectMap ;
...
map:om_022 rml:reference "Priority" ;
    rdf:type rr:ObjectMap ;
    rr:datatype xsd:integer ;
    rr:termType rr:Literal .

map:om_023 rml:reference "RemainingWork" ;
    rdf:type rr:ObjectMap ;
    rr:datatype xsd:string ;
    rr:termType rr:Literal .

map:om_024 rml:reference "ActualWork" ;
    rdf:type rr:ObjectMap ;
    rr:datatype xsd:string ;
    rr:termType rr:Literal .
...
map:om_027 rml:reference "GUID" ;
    rdf:type rr:ObjectMap ;
    rr:termType rr:Literal .

map:om_028 rml:reference "UID" ;
    rdf:type rr:ObjectMap ;
    rr:termType rr:Literal .

map:om_029 rml:reference "CreationDate" ;
    rdf:type rr:ObjectMap ;
    rr:datatype xsd:dateTime ;
    rr:termType rr:Literal .
...
map:om_032 rml:reference "GUID" ;
    rdf:type rr:ObjectMap ;
    rr:termType rr:Literal .

map:om_033 rml:reference "CreationDate" ;
    rdf:type rr:ObjectMap ;
    rr:datatype xsd:dateTime ;
    rr:termType rr:Literal .
...
map:om_035 rml:reference "TaskUID" ;
    rdf:type rr:ObjectMap ;
    rr:termType rr:Literal .

map:om_036 rml:reference "ResourceUID" ;
    rdf:type rr:ObjectMap ;
    rr:termType rr:Literal .
...
map:om_042 rml:reference "StartDate" ;
    rdf:type rr:ObjectMap ;
    rr:datatype xsd:dateTime ;
    rr:termType rr:Literal .
...
map:om_044 rml:reference "FinishDate" ;
    rdf:type rr:ObjectMap ;
    rr:datatype xsd:dateTime ;
    rr:termType rr:Literal .
...
map:om_049 rml:reference "Start" ;
    rdf:type rr:ObjectMap ;
    rr:datatype xsd:dateTime ;
    rr:termType rr:Literal .
...
map:om_051 rml:reference "Finish" ;
    rdf:type rr:ObjectMap ;
    rr:datatype xsd:dateTime ;
    rr:termType rr:Literal .
...
map:om_056 rml:reference "Start" ;
    rdf:type rr:ObjectMap ;
    rr:datatype xsd:dateTime ;
    rr:termType rr:Literal .
...
map:om_058 rml:reference "Finish" ;
    rdf:type rr:ObjectMap ;
    rr:datatype xsd:dateTime ;
    rr:termType rr:Literal .
